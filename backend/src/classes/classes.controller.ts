...
@ApiTags('Classes') @ApiBearerAuth('JWT-Auth')
@UseGuards(JwtAuthGuard, RolesGuard) @Controller('classes')
export class ClassesController {
  constructor(private s: ClassesService) {}
  @Post() @Roles('ADMIN') create(@Body() dto: any) { return this.s.create(dto); }
  @Get() @Roles('ADMIN','TEACHER','STUDENT') findAll(@Query() q: any) { return this.s.findAll(q); }
