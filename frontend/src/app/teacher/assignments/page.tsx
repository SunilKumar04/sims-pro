...
const BLANK: AForm = { className:'', subject:'', title:'', description:'', dueDate:'', maxMarks:10 };
  ...
  return (
    <AppShell title="My Assignments" subtitle="Create, track and grade assignments">
      ...
      <div className="glass rounded-2xl p-4 mb-5 flex flex-wrap items-center justify-between gap-4">
        ...
        <button onClick={() => { setForm({...BLANK,className:filterCls,subject:mySubjects(filterCls)[0]??''}); setModal(true); }}
      ...
      {loading
        ...
        : assignments.length === 0
          ? <div className="glass rounded-2xl py-20 text-center">
              ...
              <button onClick={() => { setForm(BLANK); setModal(true); }} className="px-6 py-2.5 rounded-xl text-sm font-bold"
            ...
            <div className="overflow-auto max-h-[60vh]">
              {(detail.submissions ?? []).length === 0
                ...
                : <table className="sims-table">
                    <thead><tr><th>#</th><th>Student</th><th>Roll</th><th>Submitted</th><th>Status</th><th>Marks</th><th>Action</th></tr></thead>
                    <tbody>
